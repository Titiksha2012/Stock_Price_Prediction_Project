...
# Move the model loading inside the callback function
...
new_data["Predictions"] = np.nan


@app.callback(Output("Predicted Data", "figure"), [Input("Actual Data", "figure")])
def update_predicted_data(_):
    # Move the model loading inside the callback function
    model = load_model("saved_model.h5")
    ...
    # Placeholder: You should replace this with your actual logic for updating the figure
    figure = {
        "data": [
            go.Scatter(
                x=valid.index,
